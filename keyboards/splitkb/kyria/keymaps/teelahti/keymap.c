 ...
 * | Med  |   Z  |   X  |   C  |   V  |   B  |      |      |  |      |      |   N  |   M  |   ,  |   .  |   -  |      |
 * `--------------------+------+------+------+------+------|  |------+------+------+------+------+--------------------'
 *                      | F19  | F18  |  Del | Space| Enter|  | Enter| Space| Bspc | Lead |      |
 ...
 */
    [_QWERTY] = LAYOUT(
      ...
      LT_MED,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   LT_NAV, KC_DEL, QK_LEAD, KC_BSPC,  KC_N,   KC_M,    KC_COMM, KC_DOT,  FI_MINS, KC_NO,
                               KC_F19, KC_F18, LT_NUM, LT_SPC2,LT_ENT, LT_ENT2, LT_SPC,   KC_BSPC, QK_LEAD,KC_NO
    ),
/*
 ...
 */
    [_QWERTY_LINUX] = LAYOUT(
      ...
      KC_TAB,  HOME_A, HOME_S, HOME_D, HOME_F, KC_G,                                      KC_H,   HOME_J,  HOME_K,  HOME_L,  HOME_OE, FI_ADIA,
      LT_MED,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   LT_NAV, KC_DEL, QK_LEAD, KC_BSPC,  KC_N,   KC_M,    KC_COMM, KC_DOT,  FI_MINS, KC_NO,
                               KC_F19, KC_F18, LT_NUM, LT_SPC2,LT_ENT, LT_ENT2, LT_SPCL,  KC_BSPC, QK_LEAD,KC_NO
    ),
/*
...
static void render_status(void) {
    ...
    // could just use 'get_highest_layer(layer_state)'. Based on this article:
    //   https://www.reddit.com/r/olkb/comments/o5924u/get_highest_layer_and_default_layer_change/
